/* Stack Manager — turns a Docker Hub or local image reference into a compose
 * file. Copyright 2026, Stack Manager contributors. GPL-2.0.
 *
...
(function () {
  ...
  var CA = (typeof window !== 'undefined' && window.StackmanCA) ||
    (typeof require === 'function' ? require('./ca-convert.js') : null);
  var CM = (typeof window !== 'undefined' && window.StackmanYaml) ||
  ...
  // normaliseName() so it satisfies stackman_valid_name().
  ...
  if (typeof window !== 'undefined') window.StackmanImage = API;
